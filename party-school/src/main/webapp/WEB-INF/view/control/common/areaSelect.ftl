<#macro areaSelect provinceList provinceControlName="provinceId" cityControlName="cityId" areaControlName="areaId"  selectedProvinceId=""  selectedCityId="" selectedAreaId="">
<div class="col-md-4">
    ...
    <select class="form-control chzn-select" name="${provinceControlName}" data-placeholder="选择省份" id="${provinceControlName}"
        ...
        <#list provinceList as model>
            <#if selectedProvinceId != "" && model.code==selectedProvinceId>
