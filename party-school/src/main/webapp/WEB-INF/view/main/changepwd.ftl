...
<div class="panel panel-default">
	<form class="form-horizontal form-border" data-parsley-validate method="post">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="password" class="form-control input-sm parsley-validated"
                           ...
                           data-parsley-required-message="请输入原密码"
                           placeholder="6-20位之间"
                           name="oldPassword">
				</div><!-- /.col -->
			</div><!-- /form-group -->
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="password" class="form-control input-sm parsley-validated"
                           ...
                           data-parsley-length-message="必须在6-20位之间"
                           placeholder="6-20位之间"
                           name="password"
                           id="password">
				</div><!-- /.col -->
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="password" class="form-control input-sm parsley-validated"
                           data-parsley-required="true"
                           data-parsley-required-message="请再次输入密码"
                           data-parsley-equalto="#password"
                           data-parsley-equalto-message="两次密码输入不一致"
                           data-parsley-length="[6,20]"
                           data-parsley-length-message="6-20位之间"
                           placeholder="6位以上，必须包含数字和字母"
                           name="password2">
				</div><!-- /.col -->
			</div><!-- /form-group -->
		</div>
		<div class="panel-footer">
			<div class="text-right">
                <button class="btn btn-sm btn-info" type="button" onclick="location.href='${basePath}/main/index'">返回</button>
