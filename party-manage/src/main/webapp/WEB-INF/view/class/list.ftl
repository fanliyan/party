...
<@master.masterFrame pageTitle=["院系管理","班级管理","班级列表"]>
...
<div class="panel panel-default table-responsive">
    ...
    <div class="panel-body">
        <div class="panel-body ">
            <a class="btn btn-xs btn-info" href="${basePath}/class/add/${id}"><i class="fa fa-plus fa-lg"></i> 新增</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-xs btn-warning"
                                   href="${basePath}/class/edit?id=${d.id}"><i
