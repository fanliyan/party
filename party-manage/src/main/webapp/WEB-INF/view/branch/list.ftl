...
<@master.masterFrame pageTitle=["院系管理","支委/支部管理","支委/支部列表"]>
...
<div class="panel panel-default table-responsive">
    ...
    <div class="panel-body">
        <div class="panel-body ">
            <a class="btn btn-xs btn-info" href="${basePath}/branch/add/${id}"><i class="fa fa-plus fa-lg"></i> 新增</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-warning"
                                   href="${basePath}/branch/edit?id=${d.id}"><i
