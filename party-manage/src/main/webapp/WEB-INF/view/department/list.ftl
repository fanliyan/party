...
<@master.masterFrame pageTitle=["院系管理","学院管理","学院列表"]>
...
<div class="panel panel-default table-responsive">
    ...
    <div class="panel-body">
        <div class="panel-body ">
            <a class="btn btn-xs btn-info" href="${basePath}/department/add"><i class="fa fa-plus fa-lg"></i> 新增</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-info"
                                   href="${basePath}/xi/list/${d.id}"><i
                                        class="fa  fa-info  fa-lg"></i> 修改系</a>
                                <a class="btn btn-xs btn-default"
                                   href="${basePath}/branch/list/${d.id}"><i
                                        class="fa  fa-info  fa-lg"></i> 修改支委/支部</a>

                                <a class="btn btn-xs btn-warning"
                                   href="${basePath}/department/edit?id=${d.id}"><i
